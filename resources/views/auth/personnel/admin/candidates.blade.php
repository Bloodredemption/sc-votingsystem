  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link active" href="{{ route('personnels.candidates') }}" aria-expanded="false">
                <span>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Candidate List</h5>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Position List</h5>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Partylist</h5>
