      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link active" href="{{ route('personnels.about') }}" aria-expanded="false">
                <span>
      ...
      <header class="app-header">
        <nav class="navbar navbar-expand-lg navbar-light">
          <ul class="navbar-nav">
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">System / About</span>
            </li>
          </ul>
              ...
              <div class="grid grid-cols-2 lg:grid-cols-3 gap-12">
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4"><img class="rounded-lg w-20 h-20" alt="No alt" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=900&amp;h=900&amp;q=80" />
                  <div class="sm:flex sm:flex-col sm:h-full">
                    <div class="">
                      <h3 class="font-medium text-gray-800 dark:text-black">David Forren</h3>
                ...
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4"><img class="rounded-lg w-20 h-20" alt="No alt" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=900&amp;h=900&amp;q=80" />
                  <div class="sm:flex sm:flex-col sm:h-full">
                    <div class="">
                      <h3 class="font-medium text-gray-800 dark:dark:text-black">Amil Evara</h3>
                ...
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4"><img class="rounded-lg w-20 h-20" alt="No alt" src="https://images.unsplash.com/photo-1548142813-c348350df52b?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=900&amp;h=900&amp;q=80" />
                  <div class="sm:flex sm:flex-col sm:h-full">
                    <div class="">
                      <h3 class="font-medium text-gray-800 dark:dark:text-black">Ebele Egbuna</h3>
                ...
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4"><img class="rounded-lg w-20 h-20" alt="No alt" src="https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=900&amp;h=900&amp;q=80" />
                  <div class="sm:flex sm:flex-col sm:h-full">
                    <div class="">
                      <h3 class="font-medium text-gray-800 dark:dark:text-black">Maria Powers</h3>
                ...
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4"><img class="rounded-lg w-20 h-20" alt="No alt" src="https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=900&amp;h=900&amp;q=80" />
                  <div class="sm:flex sm:flex-col sm:h-full">
                    <div class="">
                      <h3 class="font-medium text-gray-800 dark:dark:text-black">Delia Pawelke</h3>
                ...
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4"><img class="rounded-lg w-20 h-20" alt="No alt" src="https://images.unsplash.com/photo-1624224971170-2f84fed5eb5e?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=900&amp;h=900&amp;q=80" />
                  <div class="sm:flex sm:flex-col sm:h-full">
                    <div class="">
                      <h3 class="font-medium text-gray-800 dark:dark:text-black">Tom Lowry</h3>
                      <p class="mt-1 text-xs uppercase text-gray-500">UI/UX Designer</p>
                    </div>
                    <div class="mt-2 sm:mt-auto space-x-2.5"><a class="inline-flex justify-center items-center text-gray-500 hover:text-gray-800 dark:hover:text-gray-200" href="#"><span class="w-3.5 h-3.5"><svg class="w-3.5 h-3.5" class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"></path>
