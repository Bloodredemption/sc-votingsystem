...
<head>
    ...
    <title>Digi-cast: Digital Voting System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg ">
        <div class="container">
        <a class="navbar-brand" ><img src="{{ URL('images/logo-lgg2.png') }}" alt="Council Cast Logo" style="max-width: 430px; height: auto; left: 30px; width: 30%;"></a>
